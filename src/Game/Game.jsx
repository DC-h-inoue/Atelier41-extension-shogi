...
import { calculateMovableSquare, updateBoardPieces, clearSelectedOrMovableSquareStatus } from "../utils/helper";
  ...
  const onPieceClick = (rowIndex, columnIndex) => {
    ...
    if (clickedPiece.status === SQUARE_STATUS.CAN_MOVE) {
      ...
      if(clickedPiece.player === turnPlayer && 
        ...
        // 手番のプレイヤーの別の駒を選択した場合、一旦盤面をデフォルト状態にリセットしてから
        // 選択した駒を設定しなおす
        setSelectedPiece();
      }
    }
